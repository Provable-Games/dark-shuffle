        ...
        if spell_card.effect.modifier._type.into() != Modifier::None {
            if CardUtilsImpl::_is_requirement_met(
                ...
                CardUtilsImpl::apply_card_effect(
                    spell_card.card_type.into(), spell_card.effect, ref creature, ref battle, ref board, board_stats, false,
                );
            }

            if spell_card.extra_effect.modifier._type.into() != Modifier::None {
                if CardUtilsImpl::_is_requirement_met(
                    spell_card.extra_effect.modifier.requirement.into(), spell_card.card_type.into(), board_stats, false,
                ) {
                    CardUtilsImpl::apply_card_effect(
                        spell_card.card_type.into(), spell_card.extra_effect, ref creature, ref battle, ref board, board_stats, false,
                    );
                }
            }
        }
