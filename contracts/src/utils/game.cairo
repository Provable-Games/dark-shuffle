...
impl GameUtilsImpl of GameUtilsTrait {
    ...
    fn end_battle(
        ref world: WorldStorage, ref battle: Battle, ref game_effects: GameEffects, monster_node: MonsterNode
    ) {
    ...
    fn battle_won(
        ...
        AchievementsUtilsImpl::defeat_enemy(ref world, battle, monster_node);
        ...
        Self::add_monster_reward(ref game_effects, ref battle, monster_node);
    ...
    fn add_monster_reward(ref game_effects: GameEffects, ref battle: Battle, monster_node: MonsterNode) {
        if monster_node.monster_id == 1 {
            game_effects.card_draw += 1;
        } else if monster_node.monster_id == 2 {
            game_effects.hero_card_heal = true;
        } else if monster_node.monster_id == 3 {
            game_effects.hunter_health += 2;
            game_effects.hunter_attack += 2;
        } else if monster_node.monster_id == 15 {
            game_effects.play_creature_heal += 1;
        } else if monster_node.monster_id == 20 {
            game_effects.all_attack += 1;
        } else if monster_node.monster_id == 30 {
            game_effects.first_creature_cost += 1;
        } else if monster_node.monster_id == 55 {
            game_effects.first_attack += 1;
        } else if monster_node.monster_id == 57 {
            game_effects.first_health += 2;
        } else if monster_node.monster_id == 58 {
            game_effects.start_bonus_energy += 1;
        } else if monster_node.monster_id == 59 {
            game_effects.start_bonus_energy += 1;
        } else if monster_node.monster_id == 62 || monster_node.monster_id == 64 {
            game_effects.hunter_health += 1;
        } else if monster_node.monster_id == 60 || monster_node.monster_id == 63 || monster_node.monster_id == 65 {
            game_effects.hunter_attack += 1;
        } else if monster_node.monster_id == 67 || monster_node.monster_id == 69 {
            game_effects.brute_health += 1;
        } else if monster_node.monster_id == 68 || monster_node.monster_id == 70 {
            game_effects.brute_attack += 1;
        } else if monster_node.monster_id == 72 || monster_node.monster_id == 74 {
            game_effects.magical_health += 1;
        } else if monster_node.monster_id == 73 || monster_node.monster_id == 75 {
            game_effects.magical_attack += 1;
        } // Heal rewards
        else if monster_node.monster_id > 3 && monster_node.monster_id < 30 {
            BattleUtilsImpl::heal_hero(ref battle, 20);
        } else if monster_node.monster_id >= 31 && monster_node.monster_id <= 45 {
            BattleUtilsImpl::heal_hero(ref battle, 15);
        } else if monster_node.monster_id >= 46 && monster_node.monster_id <= 56 {
            BattleUtilsImpl::heal_hero(ref battle, 10);
        } else if monster_node.monster_id == 61 || monster_node.monster_id == 66 || monster_node.monster_id == 71 {
